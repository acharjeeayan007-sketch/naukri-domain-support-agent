"""
guardrails/input_guardrails.py - Input-Side Guardrails (PII Masking & Prompt Injection Detection).
Track: Recruitment & HR (Naukri.com) - Capstone Part 2 Task 10.

Demonstrates:
  1. Fixed-format phone number masking (e.g., +91-9876543210, 9876543210).
  2. Prompt-injection attack detection (instruction overrides, jailbreaks, system leaks).
"""
