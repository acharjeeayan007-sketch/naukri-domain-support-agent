"""
agent/schemas.py - Data contracts and response schemas for recruiter assistant.

Enforces strongly typed payload serialization across agent components:
- AgentResponseFormat: Primary payload contract
- GuardrailStatus: Input PII and prompt injection telemetry
- ComplianceAuditReport: Multi-officer audit trail
"""
