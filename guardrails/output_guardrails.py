"""
guardrails/output_guardrails.py - Post-generation groundedness verification.

Ensures generated responses are factually supported by retrieved policy context:
- Verifies n-gram and semantic consistency against retrieved source documents
- Suppresses outputs that exhibit hallucinated policy entitlements
"""
