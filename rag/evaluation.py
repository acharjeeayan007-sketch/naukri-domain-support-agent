"""
rag/evaluation.py - Comparative evaluation harness for RAG chunking strategies.

Benchmarks document-level precision and recall across candidate queries:
- Compares Fixed-Size (180 chars, 40 overlap) vs Sentence-Based boundary chunking
- Deduplicates parent document IDs from top-k retrieved chunks to evaluate retrieval quality
- Emits precision/recall metrics and recommendations based on empirical benchmark numbers
"""
