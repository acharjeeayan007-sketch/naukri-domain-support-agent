"""
rag/embeddings.py - Embedding generator and dense vector utilities.

Generates 384-dimensional dense vectors for semantic similarity matching:
- Supports local HuggingFace / SentenceTransformers when available
- Provides deterministic normalized subword-TFIDF projection for offline environments
- Includes cosine similarity computation for vector retrieval
"""
