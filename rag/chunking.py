"""
rag/chunking.py - Document chunking strategies for vector indexing.

Implements two segmentation techniques for policy documents:
- Strategy A: Fixed-size character windows (180 chars) with sliding overlap (40 chars)
- Strategy B: Sentence-boundary segmentation using regular expressions
"""
