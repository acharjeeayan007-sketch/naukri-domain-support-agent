"""
rag/vector_store.py - ChromaDB Collection Indexing for Fixed and Sentence Chunks.
Track: Recruitment & HR (Naukri.com) - Capstone Part 1 Task 3.

Indexes chunks into two distinct collections:
  - "naukri_fixed_chunks"
  - "naukri_sentence_chunks"
Uses collection.upsert() with cosine similarity.
"""
