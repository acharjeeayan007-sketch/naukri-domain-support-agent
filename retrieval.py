"""
rag/retrieval.py - Grounded Generation with Calibrated Fallback Threshold.
Track: Recruitment & HR (Naukri.com) - Capstone Part 1 Task 4.

Threshold Calibration:
  - In-scope cluster top-1 similarities: 0.2047 to 0.2594 (Mean: 0.2311)
  - Out-of-scope cluster top-1 similarities: 0.0986 to 0.1568 (Mean: 0.1239)
  - Empirically chosen cutoff threshold: 0.1800 (midpoint between observed clusters)
"""
